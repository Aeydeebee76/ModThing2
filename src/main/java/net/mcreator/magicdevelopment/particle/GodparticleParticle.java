...
package net.mcreator.magicdevelopment.particle;
...
public class GodparticleParticle extends MagicdevelopmentModElements.ModElement {
	public static final BasicParticleType particle = new BasicParticleType(false);
	public GodparticleParticle(MagicdevelopmentModElements instance) {
		super(instance, 14);
	...
	public void registerParticleType(RegistryEvent.Register<ParticleType<?>> event) {
		event.getRegistry().register(particle.setRegistryName("godparticle"));
	}
